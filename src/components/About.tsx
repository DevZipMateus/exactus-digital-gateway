...
const About = () => {
  const values = [{
    icon: Award,
    title: "Excelência",
    description: "Buscar sempre a qualidade máxima na prestação de nossos serviços"
  }, {
    icon: Target,
    title: "Integridade",
    description: "Agir com ética, transparência e responsabilidade em todas as ações"
  }, {
    icon: Eye,
    title: "Comprometimento",
    description: "Dedicar-se integralmente às necessidades e objetivos de nossos clientes"
  }];
  return <section id="sobre" className="py-12 md:py-16 lg:py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto mb-10 md:mb-16">
          <video src="/video.mp4" autoPlay loop muted playsInline className="w-full h-48 sm:h-64 md:h-80 lg:h-96 object-cover rounded-lg shadow-lg" aria-label="Vídeo sobre a Exactus Consultoria">
        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-12 mb-10 md:mb-16 max-w-6xl mx-auto">
          ...
          <Card className="border-primary/20 shadow-md hover:shadow-lg transition-shadow">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Ser reconhecido como a principal consultoria com referência em licitação e contratos, destacando-se pela
excelência, inovação e integridade, contribuindo para o
desenvolvimento econômico e a valorização de nossos clientes
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            {values.map((value, index) => <Card key={index} className="text-center border-primary/20 hover:border-primary transition-colors shadow-sm hover:shadow-md">
                <CardContent className="p-8">
